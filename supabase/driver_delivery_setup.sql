...
returns jsonb language plpgsql security definer set search_path=public as $$
declare d public.driver_accounts; v_order public.orders; v_hash text; result jsonb;
begin
  ...
  return jsonb_build_object('ok',true,'driver_name',d.driver_name,'order_id',v_order.id,'outlets',result);
end $$;
